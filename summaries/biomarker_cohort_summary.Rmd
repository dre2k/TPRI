---
title: "TPRI Biomarker Cohort summary"
...
bm <- readRDS("../data/bm_pnc_match_711.rds")
pnc_health <- readRDS("../data/2022_01_14_out/tpri_ehr_subset_2022_01_14.rds")

out <- inner_join(bm, pnc_health, pop_record_id)
```

EHR variable summaries for the biomarker study cohort 

--- 

# Vaccination information from EHR
```{r}
